...
class ProfileBloc extends Bloc<ProfileEvent, ProfileState> {
  ...
  ProfileBloc({required this.initialUserData, this.initialAvatar}) : super(initialUserData != null?ProfileInitial(userData: initialUserData, avatar: initialAvatar):ProfileError(userData: UserModel(fullName:"NA", email: "NA", password: ""), avatar: initialAvatar, message: 'User data unavailable')) {
